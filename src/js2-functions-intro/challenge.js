...
export const celsiusToFahrenheit = (tempInCelsius) => {
  ...
  const message =  tempInCelsius + " degrees celsius is " + fahrenheit + " degrees fahrenheit";
  return message;
};
...
export const calculateLifetimeSupply = (snickersPerDay, age, maxAge) => {
    const lifetimeSupply = snickersPerDay * 365 * (maxAge - age);
...
export const calculateAreaOfCirlce = (radius) => {
  ...
  const areaTo2Decimal = area.toFixed(2);
    return parseFloat(areaTo2Decimal);
};
